        ...
        <section className="relative overflow-hidden bg-gray-50">
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px8">
                ...
                <div className="text-center mb-16">
                    <h2 className="font-bold uppercase text-rose-500 text-xl">How it works</h2>
                    <h3 className="font-bold text-3xl max-w-2xl mx-auto ">Transform any PDF into an esay-to-digest summary in three simple steps</h3>
                </div>
