    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          <Badge
            variant="secondary"
            className="relative px-4 py-1.5 text-sm font-medium bg-white/80 text-rose-500 backdrop-blur-xl rounded-full hover:bg-white/90 transition-all duration-200 shadow-xs hover:shadow-md"
          >
        ...
        <h1 className=" text-2xl lg:text-4xl font-black lg:tracking-tight">
